...
3. Check each of these axes against the docs, citing the specific doc + rule for every finding:
   ...
   - **Implementation conventions**: Tailwind token usage matches IMPLEMENTATION.md (e.g. `bg-fade-black`, `text-fade-cream`, not raw hex or ad hoc colors).
